...
UPDATE `item_template` SET `BuyPrice`=1000000, `SellPrice`=250000, `ItemLevel`=40, `RequiredLevel`=40 WHERE `entry`=13086; -- Reins of the Winterspring Frostsaber
UPDATE `item_template` SET `BuyPrice`=1000000, `SellPrice`=0, `ItemLevel`=40, `RequiredLevel`=40 WHERE `entry` IN (
...
UPDATE `item_template` SET `BuyPrice`=100000, `SellPrice`=0, `ItemLevel`=20, `RequiredLevel`=20 WHERE `entry`=33976; -- Brewfest Ram
